...
function Cert() {
  ...
  const certification = (e) => {
    ...
    Axios.post('https://prod-02.centralus.logic.azure.com:443/workflows/ea85f43dfc9d430dbdaedf3ea206d5c5/triggers/manual/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=OHt4dkdIAk6P8gZVeUb8Y-H0s1VTCCjRbTof1fEkjcs',{email : CertMailReg}).then((response => {
    console.log(response);
  }));
  };
