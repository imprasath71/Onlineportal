...
const reg = (event) => {
    ...
    Axios.post('https://prod-00.centralus.logic.azure.com:443/workflows/850816a508f24c3595cf286f5873ec8d/triggers/manual/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=zsL2_9Q4bhfibFfD6TWbgjVCU6j3QRKGk7GkcmTBepw',{username:usernameReg,password:passwordReg,email:emailReg}).then((response => {
    console.log(response);
  }));
  };
